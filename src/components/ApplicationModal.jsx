    ...
    >
      ...
      >
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-5">
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg h-24 sm:h-32 focus:outline-none focus:border-blue-500 text-sm sm:text-base resize-none"
            ></textarea>
        ...
        <div className="sticky bottom-0 bg-white flex flex-col sm:flex-row gap-3 sm:gap-4 justify-end p-4 sm:p-6 border-t border-gray-200">
          ...
          <button className="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 bg-blue-900 text-white rounded-lg font-semibold hover:bg-blue-800 transition-all text-sm sm:text-base order-1 sm:order-2">
