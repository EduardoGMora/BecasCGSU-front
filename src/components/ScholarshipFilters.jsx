  ...
  return (
    <section className="bg-white p-6 rounded-lg shadow-sm mb-8">
      <h3 className="text-xl font-bold text-primary-purple mb-4">
        <FontAwesomeIcon icon="fa-solid fa-filter" className="mr-2" iconColor="text-primary-purple" />
        Filtros de Búsqueda
      </h3>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 items-end ">
        <div>
          <label className="block font-semibold mb-2 text-primary-purple">Estado</label>
          <select 
            name="status" 
        ...
        <div>
          <label className="block font-semibold mb-2 text-primary-purple">Tipo de Beca</label>
          <select 
        ...
        <div>
          <label className="block font-semibold mb-2 text-primary-purple">Centro Universitario</label>
          <select 
        ...
        <button 
          onClick={onClear} 
          className="px-5 py-2 border border-primary-purple text-primary-purple rounded-lg font-semibold hover:bg-primary-purple hover:text-white transition-all"
        >
          Limpiar
        </button>
        ...
        <button 
          onClick={onApply} 
          disabled={loading}
          className="px-5 py-2 bg-primary-purple text-white rounded-lg font-semibold hover:bg-primary-pink transition-all disabled:bg-gray-400 disabled:cursor-not-allowed"
        >
          Aplicar
        </button>
      </div>
