...
export function Footer() {
    ...
    return (
        <footer className="bg-ui-textMuted border-t border-ui-border mt-12 rounded-t-3xl">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3">
                                <FontAwesomeIcon icon="fa-solid fa-phone" className="text-white mt-1" />
                                <div className="text-sm">
                                    <p className="text-white">33 3134-2222 <span className="text-white text-xs">Ext. 12345</span></p>
                                </div>
                            </li>
                            <li className="flex items-start gap-3">
