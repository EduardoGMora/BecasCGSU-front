    ...
    return (
        <>
            ...
            <section className="bg-white rounded-lg shadow-sm overflow-hidden">
                <div className="bg-primary-purple text-white px-6 py-4">
                ...
                <table className="w-full">
                    ...
                    {applications.map(app => (
                        ...
                        <td className="px-6 py-4">
                            ...
                            <button onClick={() => openModal('view', app)} className="px-3 py-1 bg-primary-cyan text-white rounded text-sm font-semibold hover:bg-primary-purple transition-all">
                                Ver
                            </button>
                            {app.status === 'pending' && (
                                <button onClick={() => openModal('edit', app)} className="px-3 py-1 bg-primary-purple text-white rounded text-sm font-semibold hover:bg-primary-pink transition-all">
                                Editar
                                </button>
                            )}
                            </div>
                ...
                {selectedApp && (
                    <div className="space-y-4">
                        <div className="bg-primary-purple text-white p-4 rounded-lg">
                            ...
                            <p className="text-purple-100">{selectedApp.institution}</p>
                        </div>

                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-green-50 p-4 rounded-lg border-l-4 border-primary-mint">
                                <div className="text-xs text-gray-800 mb-1">Monto</div>
                                <div className="text-2xl font-bold text-primary-mint">{selectedApp.amount}</div>
                            </div>
                            <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-primary-cyan">
                                <div className="text-xs text-gray-800 mb-1">Estado</div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="bg-gray-50 p-3 rounded-lg">
                                ...
                                <div className="font-semibold text-primary-purple">{selectedApp.promedio}</div>
                            </div>
                        </div>
            ...
            <Modal isOpen={modalType === 'edit'} onClose={closeModal} title="Editar Solicitud">
                {selectedApp && (
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-primary-cyan">
                            <div className="text-sm text-gray-800">Solo puedes editar tu promedio y motivación mientras la solicitud está en proceso</div>
                        </div>
                        ...
                        <div className="flex gap-3 pt-4 border-t">
                            ...
                            <button type="submit" className="flex-1 px-4 py-3 bg-primary-purple text-white rounded-lg font-semibold hover:bg-primary-pink transition-all shadow-lg">
                                Guardar Cambios
                            </button>
                        </div>
                    </form>
