    ...
    <>
      ...
      <article className="my-8 lg:flex items-center gap-8">
        ...
        <div className="flex flex-col items-center mb-4">
          <div className="flex items-center mb-4">
            <FontAwesomeIcon icon="fas fa-info-circle" className="text-ui-textMuted text-2xl mr-3" />
            <h1 className="font-display text-ui-textMuted text-3xl font-bold mb-4">Bienvenido al Portal de Becas CGSU</h1>
          </div>
      ...
      <section>
        <div className="flex justify-between items-center mb-6">
          <h2 className="font-display text-3xl font-bold text-blue-900">Becas Destacadas</h2>
          <Link 
